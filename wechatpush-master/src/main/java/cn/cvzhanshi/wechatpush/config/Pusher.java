...
public class Pusher {
    ...
    private static String appId = "wxf0e199a5cf28c151";
    private static String secret = "82bfad28796fe10e154435646e30cc3a";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("oXZRv6TqQkfMv9KwKqqBYhHTE0OU")
                .templateId("qE_gs2pWx4vRV51NtZMkAAiiqltIXSg2Kx2dZ9-pVQU")
                .build();
