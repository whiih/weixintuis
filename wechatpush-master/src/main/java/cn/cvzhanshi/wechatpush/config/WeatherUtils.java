...
public class WeatherUtils {
    ...
    public static Weather getWeather(){
        ...
        map.put("district_id","140800"); // 运城行政代码
        map.put("data_type","all");//这个是数据类型
        map.put("ak","3sk19syGDknv0ClYt9cr0mSlrV7mCR0X");
        String res = restTemplate.getForObject("https://api.map.baidu.com/weather/v1/?district_id={district_id}&data_type={data_type}&ak={ak}",
                String.class,
                map);
